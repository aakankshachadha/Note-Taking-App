...
class Dashboard:
    ...
    def search_callback(self):
        """
        method used to search the notes.
        :return:
        will return the note if present else invalid action.
        """
    ...
    def list_all_callback(self):
        """
        method used to list all notes which are present in notetaking app
        :return:
        returns all notes.
        """
        try:
    ...
    def edit_callback(self):
        ...
        """
        try:
            EditNote().initUI(self,self.db,self.cur_notes[self.listbox.curselection()[0]])
        except Exception as e:
            pass
    ...
    def add_callback(self):
        """
        method used to add new note to our app.
        :return:
    ...
    def initUI(self,db):
        """
        tkinter is used to make the user interface.
        """
        self.db=db
        self.root = Tk()
        ...
        self.search_label=Label(self.root,text="Search Your Notes Here",font=self.Font)
